...
const passTests = [
  ...
  { n: 'FixedArray Basic', t: new types.FixedArray(3, () => new types.UInt()), io: Buffer.from([0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1]), e: [new types.Int(1), new types.Int(1), new types.Int(1)] },
  ...
  { n: 'VarArray Basic', t: new types.VarArray(3, () => new types.UInt()), io: Buffer.from([0, 0, 0, 3, 0, 0, 0, 1, 0, 0, 0, 2, 0, 0, 0, 1]), e: [new types.Int(1), new types.Int(2), new types.Int(1)] },
  ...
  { n: 'Union Basic', t: new types.Union(testEnum, [new types.Int(), new types.Int(), new types.Int()]), io: Buffer.from([0, 0, 0, 2, 0, 0, 0, 4]), e: new types.Int(4) },
...
const failTests = [
  ...
  { n: 'FixedArray Wrong value', t: new types.FixedArray(1, () => new types.Str()), io: Buffer.from([0, 0, 0, 1]) },
